                    ...
                    <div class="p-6 space-y-6">
                        ...
                        <div class="space-y-4 pt-6 border-t border-gold/30">
                            <div class="flex flex-wrap gap-4">
                                <a href="#" class="inline-flex items-center px-4 py-2 bg-gold hover:bg-gold-light text-midnight-dark font-bold rounded-md transition-colors">
                                ...
                                <a href="#characters" class="inline-flex items-center px-4 py-2 bg-midnight-light hover:bg-gold/20 text-gold font-bold rounded-md transition-colors border border-gold/30">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">

...
@section('meta-description',
    'Manage your ASRO account settings, security, and character information from one central
    dashboard.')
                        ...
                        <form action="{{ route('website.update.profile') }}" method="POST">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-1 gap-6">
                                ...
                                <div>
                                    ...
                                    <select name="sex" class="w-full bg-midnight border border-gold/20 rounded-md px-4 py-2 text-sand-light">

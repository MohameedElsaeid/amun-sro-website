...
@section('meta-keywords', 'Ranking, Top Players, Leaderboard, ASRO Rankings, Silkroad Private Server, Player Rankings, Warrior Rankings, Amun Sro')

@section('content')
    <!-- Hero Section -->
    <div class="page-hero page-hero-accent relative" style="background-image: url('{{ asset('icons/feat_6.webp') }}');">
        <div class="container mx-auto px-4 text-center relative z-10">
            ...
            <p class="text-xl md:text-2xl text-sand-light max-w-3xl mx-auto mb-8 hero-animate hero-animate-delay-1">
                Discover the most powerful warriors in Amun Sro's ancient world
            </p>
    ...
    <section id="rankings-table" class="py-16 bg-sand-light relative z-20" style="background-image: url('{{ asset('icons/feat_2_opacity_30.webp') }}');">
        <div class="container mx-auto px-4">
            <div class="bg-white rounded-lg shadow-xl overflow-hidden relative z-10">
                    ...
                    <div class="flex flex-col md:flex-row justify-between items-center">
                        ...
                        <div class="flex flex-col sm:flex-row gap-4">
                            <div class="flex space-x-2">
                                <select class="bg-midnight-light text-sand-light border border-gold-dark rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-gold">
                            ...
                            <div class="relative">
                                <input type="text" placeholder="Search character..." class="bg-midnight-light text-sand-light border border-gold-dark rounded pl-10 pr-3 py-2 w-full focus:outline-none focus:ring-2 focus:ring-gold">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 absolute left-3 top-2.5 text-gold-dark" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-left">
                        ...
                        <tr class="border-b border-sand bg-gold/5 hover:bg-gold/10 transition-colors">
                            ...
                            <td class="py-4 px-6">
                                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-gold/20 text-gold-dark">
                                    Pharaoh's Elite
                                </span>
                            </td>
                        ...
                        <tr class="border-b border-sand hover:bg-sand/10 transition-colors">
                            <td class="py-4 px-6">
                                <span class="inline-block bg-sand-dark text-white font-bold px-2 py-1 rounded text-center w-8">2</span>
                            </td>
                            ...
                            <td class="py-4 px-6">
                                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-midnight-light/20 text-midnight">
                                    Dark Raiders
                                </span>
                            </td>
                        ...
                        <tr class="border-b border-sand hover:bg-sand/10 transition-colors">
                            <td class="py-4 px-6">
                                <span class="inline-block bg-sand-dark text-white font-bold px-2 py-1 rounded text-center w-8">3</span>
                            </td>
                        ...
                        <tr class="border-b border-sand hover:bg-sand/10 transition-colors">
                            <td class="py-4 px-6">
                                <span class="inline-block bg-midnight-light/20 text-midnight font-bold px-2 py-1 rounded text-center w-8">4</span>
                            </td>
                        ...
                        <tr class="border-b border-sand hover:bg-sand/10 transition-colors">
                            <td class="py-4 px-6">
                                <span class="inline-block bg-midnight-light/20 text-midnight font-bold px-2 py-1 rounded text-center w-8">5</span>
                            </td>
                ...
                <div class="flex flex-col md:flex-row justify-between items-center p-6 border-t border-sand bg-midnight-light/5">
                    ...
                    <div class="flex flex-wrap justify-center gap-2">
                        ...
                        <button class="px-3 py-1 bg-midnight text-sand-light rounded hover:bg-midnight-dark">
                            Next
                        </button>
                    </div>
                </div>
                    ...
                    <div class="p-6">
                        <ul class="space-y-4">
                            <li class="flex items-center justify-between">
                                <div class="flex items-center">
                                    <span class="inline-block bg-gold text-white font-bold px-2 py-1 rounded text-center w-8 mr-3">1</span>
                            ...
                            <li class="flex items-center justify-between">
                                <div class="flex items-center">
                                    <span class="inline-block bg-sand-dark text-white font-bold px-2 py-1 rounded text-center w-8 mr-3">2</span>
                            ...
                            <li class="flex items-center justify-between">
                                <div class="flex items-center">
                                    <span class="inline-block bg-sand-dark text-white font-bold px-2 py-1 rounded text-center w-8 mr-3">3</span>
                            ...
                            <li class="flex items-center justify-between">
                                <div class="flex items-center">
                                    <span class="inline-block bg-midnight-light/20 text-midnight font-bold px-2 py-1 rounded text-center w-8 mr-3">4</span>
                            ...
                            <li class="flex items-center justify-between">
                                <div class="flex items-center">
                                    <span class="inline-block bg-midnight-light/20 text-midnight font-bold px-2 py-1 rounded text-center w-8 mr-3">5</span>
                    ...
                    <div class="p-6">
                        <ul class="space-y-4">
                            <li class="flex items-center justify-between">
                                ...
                                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-gold/20 text-gold-dark">1,245 Kills</span>
                            </li>
                            <li class="flex items-center justify-between">
                                <div class="flex items-center">
                                    <span class="inline-block bg-sand-dark text-white font-bold px-2 py-1 rounded text-center w-8 mr-3">2</span>
                                ...
                                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-midnight-light/20 text-midnight">1,120 Kills</span>
                            </li>
                            <li class="flex items-center justify-between">
                                <div class="flex items-center">
                                    <span class="inline-block bg-sand-dark text-white font-bold px-2 py-1 rounded text-center w-8 mr-3">3</span>
                                ...
                                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-midnight-light/20 text-midnight">980 Kills</span>
                            </li>
                            <li class="flex items-center justify-between">
                                <div class="flex items-center">
                                    <span class="inline-block bg-midnight-light/20 text-midnight font-bold px-2 py-1 rounded text-center w-8 mr-3">4</span>
                                ...
                                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-midnight-light/20 text-midnight">890 Kills</span>
                            </li>
                            <li class="flex items-center justify-between">
                                <div class="flex items-center">
                                    <span class="inline-block bg-midnight-light/20 text-midnight font-bold px-2 py-1 rounded text-center w-8 mr-3">5</span>
                                ...
                                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-midnight-light/20 text-midnight">865 Kills</span>
                            </li>
                        </ul>
                        <div class="mt-4 text-center">
            ...
            <div class="mt-16 bg-white rounded-lg shadow-xl overflow-hidden">
                ...
                <div class="p-6">
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div class="achievement-card border border-sand rounded-lg p-4 hover:border-gold transition-colors">
                            ...
                            <p class="text-midnight">Anubis_King completed the Temple of Osiris on Legendary difficulty</p>
                        </div>
                        ...
                        <div class="achievement-card border border-sand rounded-lg p-4 hover:border-gold transition-colors">
                            ...
                            <p class="text-midnight">MysticQueen has reached level 117 - the first High Priest to do so</p>
                        </div>
                    </div>
                </div>
            </div>

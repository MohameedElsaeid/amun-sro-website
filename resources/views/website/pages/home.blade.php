...
@section('content')
    ...
    <section class="relative py-12 z-20 bg-midnight/80"
             style="background-image: url('{{ asset('icons/feat_5_opacity_30.webp') }}');">
    ...
    <section class="relative py-20 z-20" style="background-image: url('{{ asset('icons/feat_1_opacity_30.webp') }}');">
        <div class="container mx-auto px-4">
    ...
    <section class="relative py-20 z-20" style="background-image: url('{{ asset('icons/feat_6_opacity_30.webp') }}');">
        <div class="container mx-auto px-4">
    ...
    <section class="relative py-20 bg-midnight-light z-20"
             style="background-image: url('{{ asset('icons/feat_2_opacity_30.webp') }}');">
        <div class="container mx-auto px-4">

                ...
                <div class="bg-midnight-light p-6 rounded-lg">
                    ...
                    <div class="space-y-4">
                        <div class="border-b border-gold/20 pb-4">
                            ...
                            <p class="text-sand">Visit our Downloads page and follow the installation guide. Make sure
                                your system meets the minimum requirements.</p>
                        </div>

                        <div class="border-b border-gold/20 pb-4">
                            <h3 class="text-gold font-bold mb-2">What are the system requirements?</h3>
                            <p class="text-sand">Minimum: Windows 7/8/10, 4GB RAM, 2GB free disk space, DirectX 9.0c
                                compatible graphics card.</p>
                        </div>

                        <div class="border-b border-gold/20 pb-4">
                            <h3 class="text-gold font-bold mb-2">Is the game free to play?</h3>
                            <p class="text-sand">Yes, ASRO is completely free to play. We offer optional premium items
                                through our shop.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-midnight-light p-6 rounded-lg">
                    ...
                    <div class="space-y-4">
                        <div class="border-b border-gold/20 pb-4">
                            ...
                            <p class="text-sand">Click the Register button on the top right of the website and fill out
                                the registration form.</p>
                        </div>

                        <div class="border-b border-gold/20 pb-4">
                            <h3 class="text-gold font-bold mb-2">I forgot my password. What should I do?</h3>
                            <p class="text-sand">Use the "Forgot Password" link on the login page to reset your password
                                via email.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-midnight-light p-6 rounded-lg">
                    ...
                    <div class="space-y-4">
                        <div class="border-b border-gold/20 pb-4">
                            ...
                            <p class="text-sand">Try updating your graphics drivers and DirectX. If the issue persists,
                                contact our support team.</p>
                        </div>

                        <div class="border-b border-gold/20 pb-4">
                            <h3 class="text-gold font-bold mb-2">How can I improve my game performance?</h3>
                            <p class="text-sand">Lower your graphics settings, close background applications, and ensure
                                your PC meets the requirements.</p>
                        </div>
                    </div>
                </div>
            </div>

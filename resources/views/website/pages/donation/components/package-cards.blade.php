...
<div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-6 mb-12">
    @foreach($paymentInformation['packages'] as $index => $package)
        <div class="package-card bg-white border border-sand rounded-lg overflow-hidden shadow-lg hover:shadow-2xl transition-all" data-package-id="{{ $index }}">
            ...
            <div class="package-content p-6">
                <div class="price-list space-y-2 mb-6 hidden"> <!-- Added hidden class to initially hide prices -->
                ...
                <div class="select-currency-message text-center mb-3 text-midnight-light">
                    Please select a currency to see prices
                </div>

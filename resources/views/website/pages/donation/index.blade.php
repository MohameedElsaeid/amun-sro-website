    ...
    <main class="py-10 bg-sand-light relative z-20">
        <div class="container mx-auto px-4">
            ...
            <div class="bg-white rounded-lg shadow-lg p-6 mb-10">
                <h3 class="text-2xl font-cinzel font-bold text-midnight text-center mb-6">What Players Say</h3>
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div class="bg-midnight-light/5 p-4 rounded-lg">
                        <div class="flex items-center mb-3">
                            <img src="{{ asset('icons/avatar1.png') }}" alt="Player Avatar" class="w-12 h-12 rounded-full mr-3">
                            <div>
                                <p class="font-bold text-midnight">MasterRogue92</p>
                        ...
                        <p class="text-midnight-light">"The silk packages are worth every penny. I got rare items that helped me dominate PvP battles!"</p>
                    </div>
                    <div class="bg-midnight-light/5 p-4 rounded-lg">
                        <div class="flex items-center mb-3">
                            <img src="{{ asset('icons/avatar2.png') }}" alt="Player Avatar" class="w-12 h-12 rounded-full mr-3">
                            <div>
                                <p class="font-bold text-midnight">DragonSlayer55</p>
                                <div class="flex text-gold">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" viewBox="0 0 20 20" fill="currentColor">
                                        <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                                    </svg>
                        ...
                        <p class="text-midnight-light">"Fast payment, instant Silk credit. The bonus silk makes a huge difference for serious players."</p>
                    </div>
                    <div class="bg-midnight-light/5 p-4 rounded-lg">
                        <div class="flex items-center mb-3">
                            <img src="{{ asset('icons/avatar3.png') }}" alt="Player Avatar" class="w-12 h-12 rounded-full mr-3">
                            <div>
                                <p class="font-bold text-midnight">SilkMaster21</p>
                                <div class="flex text-gold">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" viewBox="0 0 20 20" fill="currentColor">
                                        <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                                    </svg>
                        ...
                        <p class="text-midnight-light">"Since I started buying Silk regularly, my character has progressed 3x faster! Best investment for serious players."</p>
                    </div>
                </div>
            </div>

            <!-- Simple FAQ - Just 2 Important Questions -->
            <div class="bg-white rounded-lg shadow-lg p-6 mb-10">

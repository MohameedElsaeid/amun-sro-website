                ...
                <div class="space-y-8 text-sand-light">
                    ...
                    <div>
                        ...
                        <ul class="list-disc pl-6 space-y-2 mb-4">
                            ...
                            <li>Email addresses must be valid and accessible by the registrant</li>
                    ...
                    <div>
                        <h2 class="text-2xl font-cinzel font-bold text-gold mb-4">3. User Conduct</h2>
                        <p class="mb-4">Users agree to:</p>
                        <ul class="list-disc pl-6 space-y-2 mb-4">
                            <li>Follow all game rules and guidelines</li>
                            <li>Respect other players and staff members</li>
                            <li>Not engage in any form of cheating, exploitation, or unfair play</li>
                            <li>Not use unauthorized third-party software or tools that provide unfair advantages</li>
                            <li>Not engage in harassment, hate speech, or discrimination</li>
                            <li>Not distribute or promote content that is harmful, offensive, or illegal</li>
                        </ul>
                        <p>Violations may result in temporary or permanent suspension of service access.</p>
                    </div>

                    <div>
                        <h2 class="text-2xl font-cinzel font-bold text-gold mb-4">4. Virtual Items and Currency</h2>
                    ...
                    <div>
                        ...
                        <ul class="list-disc pl-6 space-y-2 mb-4">
                            ...
                            <li>Server availability and operational hours</li>
                    ...
                    <div>
                        ...
                        <ul class="list-disc pl-6 space-y-2 mb-4">
                            ...
                            <li>Copy or distribute substantial parts of the game</li>
                    ...
                    <div>
                        <h2 class="text-2xl font-cinzel font-bold text-gold mb-4">7. Limitation of Liability</h2>
                        <p class="mb-4">ASRO and its staff are not liable for:</p>
                        <ul class="list-disc pl-6 space-y-2 mb-4">
                    ...
                    <div>
                        <h2 class="text-2xl font-cinzel font-bold text-gold mb-4">9. Termination</h2>
                        <p class="mb-4">Either party may terminate this agreement:</p>
                        <ul class="list-disc pl-6 space-y-2 mb-4">
                            <li>Users may cease using our services at any time</li>
                    ...
                    <div>
                        <h2 class="text-2xl font-cinzel font-bold text-gold mb-4">10. Contact Information</h2>
                        <p class="mb-4">For questions about these Terms of Service, please contact us at:</p>
                        <p class="mb-4">Email: support@asro-game.com</p>

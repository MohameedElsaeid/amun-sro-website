<header class="relative">
    <div class="absolute top-0 w-full z-50">
            ...
            <div class="hidden md:flex space-x-6 items-center">
                ...
                @auth
                    <a href="{{ route('website.character') }}"
                       class="nav-link {{ request()->routeIs('website.character') ? 'active' : '' }}">Characters</a>
                    <a href="{{ route('website.account') }}"
                       class="nav-link {{ request()->routeIs('website.account') ? 'active' : '' }}">Account</a>
                @endauth
            </div>
            <div class="md:hidden">
                <button id="mobile-menu-button" class="text-gold-dark hover:text-gold" aria-label="Toggle navigation">
        ...
        <div id="mobile-menu" class="hidden md:hidden bg-midnight-dark bg-opacity-95 absolute w-full">
            <div class="container mx-auto px-4 py-3 flex flex-col space-y-3">
                ...
                @auth
                    <a href="{{ route('website.character') }}"
                       class="mobile-nav-link {{ request()->routeIs('website.character') ? 'active' : '' }}">Characters</a>
                    <a href="{{ route('website.account') }}"

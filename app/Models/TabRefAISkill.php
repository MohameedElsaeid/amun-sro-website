 ...
 *
 *
 * @method static Builder<static>|TabRefAISkill newModelQuery()
 * @method static Builder<static>|TabRefAISkill newQuery()
 * @method static Builder<static>|TabRefAISkill query()
 * @mixin Eloquent
 */

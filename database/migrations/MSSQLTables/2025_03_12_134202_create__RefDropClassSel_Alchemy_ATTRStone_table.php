...
class CreateRefDropClassSelAlchemyATTRStoneTable extends Migration
{
    public function up(): void
    {
        Schema::create('_RefDropClassSel_Alchemy_ATTRStone', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('_RefDropClassSel_Alchemy_ATTRStone');
    }
}

        ...
        class CreateTBNet2eTable extends Migration
        {
            public function up(): void
            {
                Schema::create('TB_Net2e', function (Blueprint $table) {
            $table->integer('JID');
            $table->string('StrUserID', 25);
            $table->string('password', 50);
            $table->string('SecondPassword', 50)->nullable();
            $table->string('question', 70)->nullable();
            $table->string('answer', 50)->nullable();
            $table->smallInteger('Status')->nullable();
            $table->smallInteger('GMrank')->nullable();
            $table->string('Name', 50)->nullable();
            $table->string('MDK', 50)->nullable();
            ...
            $table->integer('cidType')->nullable();
            ...
            $table->string('Inviter', 25)->nullable();

        ...
        class CreateRefDropClassSelAlchemyMagicStoneTable extends Migration
        {
            public function up(): void
            {
                Schema::create('_RefDropClassSel_Alchemy_MagicStone', function (Blueprint $table) {
            ...
            {
                Schema::dropIfExists('_RefDropClassSel_Alchemy_MagicStone');
            }
        }